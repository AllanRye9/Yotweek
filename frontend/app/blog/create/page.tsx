...
export default function CreatePostPage() {
  ...
  if (!user) {
    return (
      <div className="page-shell py-10 text-sm text-gray-400">
  ...
  return (
    <div className="page-shell max-w-2xl py-10 animate-fade-in">
      <h1 className="display-heading text-3xl text-gray-900 mb-6">Write a travel story</h1>
