...
export default function AdminReportsPage() {
  ...
  return (
    ...
    <div className="animate-fade-in">
      <div className="bg-gradient-to-r from-violet-700 to-indigo-700 text-white px-[10%] py-8"><div className="max-w-7xl mx-auto"><h1 className="font-extrabold text-2xl">User Reports</h1><p className="text-white/70 text-sm mt-1">Flagged content, spam, and abuse reported by the community.</p></div></div>
