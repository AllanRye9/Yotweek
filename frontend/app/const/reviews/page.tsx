...
export default function AdminReviewsPage() {
  ...
  return (
    ...
    <div className="animate-fade-in">
      <div className="bg-gradient-to-r from-violet-700 to-indigo-700 text-white px-[10%] py-8"><div className="max-w-7xl mx-auto"><h1 className="font-extrabold text-2xl">Review Moderation</h1><p className="text-white/70 text-sm mt-1">Approve, reject, or remove reviews left on events and businesses.</p></div></div>
