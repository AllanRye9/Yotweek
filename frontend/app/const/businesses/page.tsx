...
export default function AdminBusinessesPage() {
  ...
  return (
    ...
    <div className="animate-fade-in">
      <div className="bg-gradient-to-r from-violet-700 to-indigo-700 text-white px-[7%] py-8"><div className="max-w-7xl mx-auto"><h1 className="font-extrabold text-2xl">Business Management</h1><p className="text-white/70 text-sm mt-1">Review new submissions, or edit/remove any listing.</p></div></div>
